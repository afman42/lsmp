          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <form action="<?= site_url('admin/update_kelas/'.$kelas->id);?>" method="post" class="p-3">
                      <div class="form-group">
                        <input type="text" class="form-control" name="nama" placeholder="Masukan Nama Kelas" required value="<?= $kelas->nama; ?>">
                      </div>
                      <div class="form-group">
