          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <form action="<?= site_url('pengajar/insert_soal_siswa/'.$ujian->id);?>" method="post" class="p-3">
                      <div class="form-group">
                        <label>Pertanyaan</label>
                        <textarea name="pertanyaan" id="post-content"></textarea>
                      </div>
                      <div class="form-group">
                        <label>Pilihan A</label>
                        <textarea name="pg_a" id="post-content1"></textarea>
                      </div>
                      <div class="form-group">
                        <label>Pilihan B</label>
                        <textarea name="pg_b" id="post-content2"></textarea>
                      </div>
                      <div class="form-group">
                        <label>Pilihan C</label>
                        <textarea name="pg_c" id="post-content3"></textarea>
                      </div>
                      <div class="form-group">
                        <label>Pilihan D</label>
                        <textarea name="pg_d" id="post-content4"></textarea>
                      </div>
                      <div class="form-group">
