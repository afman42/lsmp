          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <form action="<?= site_url('pengajar/insert_kuis_siswa/'.$kelas->id);?>" method="post" class="p-3">
                      <div class="form-group">
                        <label>Nama Kuis</label>
                        <input type="text" name="nama_ujian" class="form-control" placeholder="Masukan Nama Kuis">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="row">
                          <div class="col-lg-6">
                            ...
                            <input type="datetime-local" name="jam_mulai" class="form-control" placeholder="Masukan Jam Mulai" required>
                          </div>
                          <div class="col-lg-6">
                            <label>Jam Selesai</label>
                            <input type="datetime-local" name="jam_selesai" class="form-control" placeholder="Masukan Jam Selesai" required>
                          </div>
                        </div>
                      </div>
                      <div class="form-group">
